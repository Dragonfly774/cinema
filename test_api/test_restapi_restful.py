...
# корректный
print(get('http://127.0.0.1:8080/api/films/1').json())
# не корректный
print(get('http://127.0.0.1:8080/api/films/404').json())


"""добавление новой фильмов с помощью POST-запроса"""
# не корректно
print(post('http://127.0.0.1:8080/api/films').json())
# не корректно
print(post('http://127.0.0.1:8080/api/films',
...
"""удаление фильмов"""
# не корректно
print(delete('http://127.0.0.1:8080/api/films/999').json())
# корректно
print(delete('http://127.0.0.1:8080/api/films/9').json())
